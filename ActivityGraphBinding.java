...
public final class ActivityGraphBinding implements ViewBinding {
  ...
  private ActivityGraphBinding(@NonNull LinearLayout rootView, @NonNull TextView textViewGraphTitle,
      @NonNull MaterialToolbar toolbar) {
    this.rootView = rootView;
    this.textViewGraphTitle = textViewGraphTitle;
  ...
  public static ActivityGraphBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.textViewGraphTitle;
      TextView textViewGraphTitle = ViewBindings.findChildViewById(rootView, id);
      if (textViewGraphTitle == null) {
        break missingId;
      }
      ...
      return new ActivityGraphBinding((LinearLayout) rootView, textViewGraphTitle, toolbar);
    }
